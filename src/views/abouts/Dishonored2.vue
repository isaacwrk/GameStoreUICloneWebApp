<template>
    <div>
        ...
        <GameStores icon="fab fa-playstation" gamePlataform="Ps "/>
        <BuyNow text="Price" priceLined="40.00" newPrice="25.00"/>
    </div>
</template>
...
const Dishonored2About = defineComponent({
    components:{
        InfoWallpaper,
        InfoDescription,
        Overview,
...
export default Dishonored2About;
</script>
